...
from sample_model_b import gen_prompt, fewshot_examples
...
def main():
    ...
    test_examples.to_json(f"data/math/correct_chain_iteration{sys.argv[1]}.json")
    test_examples = Dataset.from_list(outs_model_a)
    test_examples.to_json(f"data/math/model-a-correct_chain_iteration{sys.argv[1]}.json")
