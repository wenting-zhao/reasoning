...
dataset = datasets.load_dataset(
    "json",
    data_files="out/model-a-samples-apps-train-gpt-4o-nofsFalse-num8-start0-end128-eval.json",
)
...
attempt_idx = st.number_input("attempt number", min_value=0, max_value=len(example["code"]))
